 ...
 * 
 */
@WebServiceClient(name = "Weather", targetNamespace = "http://ws.cdyne.com/WeatherWS/", wsdlLocation = "file:/D:/J2EE/ocewsd/src/weather.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("file:/D:/J2EE/ocewsd/src/weather.wsdl");
    ...
    public ClimaSoap getWeatherSoap() {
        return super.getPort(new QName("http://ws.cdyne.com/WeatherWS/", "WeatherSoap"), ClimaSoap.class);
    }
     ...
     */
    @WebEndpoint(name = "WeatherSoap")
    public ClimaSoap getWeatherSoap(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.cdyne.com/WeatherWS/", "WeatherSoap"), ClimaSoap.class, features);
    }
