...
public interface WeatherSoap {
     ...
     * 
     * @return
     *     returns weather.client.ArrayOfWeatherDescription
     */
    ...
    @RequestWrapper(localName = "GetWeatherInformation", targetNamespace = "http://ws.cdyne.com/WeatherWS/", className = "weather.client.GetWeatherInformation")
    @ResponseWrapper(localName = "GetWeatherInformationResponse", targetNamespace = "http://ws.cdyne.com/WeatherWS/", className = "weather.client.GetWeatherInformationResponse")
     ...
     * @param zip
     * @return
     *     returns weather.client.ForecastReturn
     */
    ...
    @RequestWrapper(localName = "GetCityForecastByZIP", targetNamespace = "http://ws.cdyne.com/WeatherWS/", className = "weather.client.GetCityForecastByZIP")
    @ResponseWrapper(localName = "GetCityForecastByZIPResponse", targetNamespace = "http://ws.cdyne.com/WeatherWS/", className = "weather.client.GetCityForecastByZIPResponse")
     ...
     * @param zip
     * @return
     *     returns weather.client.WeatherReturn
     */
    ...
    @RequestWrapper(localName = "GetCityWeatherByZIP", targetNamespace = "http://ws.cdyne.com/WeatherWS/", className = "weather.client.GetCityWeatherByZIP")
    @ResponseWrapper(localName = "GetCityWeatherByZIPResponse", targetNamespace = "http://ws.cdyne.com/WeatherWS/", className = "weather.client.GetCityWeatherByZIPResponse")
