 ...
 * generated in the exception.runtime.client package. 
...
public class ObjectFactory {
    ...
    private final static QName _OperationResponse_QNAME = new QName("http://runtime.exception/", "operationResponse");
    private final static QName _Operation_QNAME = new QName("http://runtime.exception/", "operation");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: exception.runtime.client
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://runtime.exception/", name = "operationResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://runtime.exception/", name = "operation")
